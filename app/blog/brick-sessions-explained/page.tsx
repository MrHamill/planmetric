      ...
      <article className="pt-40 pb-32 px-8 md:px-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 font-body text-base leading-relaxed" style={{ color: "rgba(245,245,240,0.8)" }}>
            <motion.p {...fadeUp(0.1)}>
              Every triathlete knows the feeling. You dismount the bike, start running, and your legs feel like they belong to someone else. Heavy, uncoordinated, running on concrete stilts. This is &ldquo;brick legs&rdquo; &mdash; the neuromuscular shock of transitioning from cycling to running without any break. It happens because the muscle recruitment pattern for cycling is fundamentally different from running, and your nervous system needs time to switch.
            </motion.p>

            <motion.p {...fadeUp(0.12)}>
              The good news: this sensation diminishes with repeated practice. Brick sessions are the specific training tool designed to make the bike-to-run transition feel manageable on race day. Research and coaching best-practice from Norwegian endurance training principles confirm that brick sessions are non-negotiable in the six weeks before any triathlon.
            </motion.p>
            ...
            <motion.p {...fadeUp(0.16)}>
              The purpose is neuromuscular adaptation. Your body needs to learn how to recruit running muscles immediately after sustained cycling effort. The quadriceps have been working in a shortened range during the pedal stroke, and suddenly they need to operate through the full extension and ground-contact pattern of running. Without practice, this switch costs you minutes in the first kilometre off the bike.
            </motion.p>
            ...
            <motion.p {...fadeUp(0.28)}>
              Brick sessions are uncomfortable by design. That discomfort is the point &mdash; every brick you complete in training is one less surprise on race day. The athletes who execute the run off the bike cleanly are the ones who have practised the transition until it feels normal. Not easy, but normal.
            </motion.p>

            <motion.div className="mt-16 pt-12" style={{ borderTop: `1px solid ${RULE}` }} {...fadeUp(0.3)}>
