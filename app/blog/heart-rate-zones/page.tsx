      ...
      <article className="pt-40 pb-32 px-8 md:px-24">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 font-body text-base leading-relaxed" style={{ color: "rgba(245,245,240,0.8)" }}>
            <FadeIn delay={0.1}>
              <p>Heart rate zones are one of the most powerful tools in endurance training. They tell you exactly how hard your body is working, whether you are building aerobic fitness or burning through glycogen reserves you will need later. Yet the majority of amateur athletes either train without zones entirely or use numbers they have never calibrated.</p>
            </FadeIn>

            <FadeIn delay={0.12}>
              <p>The result is predictable. Most age-group athletes spend the majority of their training in a no-man&rsquo;s land &mdash; too hard to build aerobic base, too easy to develop threshold. Research from Norwegian coaching best-practice confirms that elite endurance athletes across cycling, running, rowing and triathlon spend 80&ndash;90% of their training at low intensity, below ventilatory threshold one. The remaining 10&ndash;20% is split between threshold and high-intensity work. Most amateurs invert this ratio.</p>
            </FadeIn>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ...
                      ["T2 — Aerobic Base", "65–75%", "Comfortable, sustainable for hours"],
                      ["T3 — Tempo", "75–85%", "Comfortably hard, short sentences"],
                      ["T4 — VO2max", "85–92%", "Hard, laboured breathing"],
