...
export const metadata: Metadata = {
  title: "How to Taper Before Race Day — Plan Metric",
  description: "A well-executed taper doesn't reduce fitness — it reveals it. Learn optimal taper duration, the volume vs intensity rule, and how to manage taper anxiety.",
  openGraph: {
    title: "How to Taper Before Race Day Without Losing Fitness",
    description: "Learn optimal taper duration, the volume vs intensity rule, and how to manage taper anxiety.",
    type: "article",
  },
};
