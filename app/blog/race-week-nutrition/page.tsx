        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-8 font-body text-base leading-relaxed" style={{ color: "rgba(245,245,240,0.8)" }}>
            ...
            <motion.p {...fadeUp(0.14)}>
              Daily protein stays at 1.6&ndash;2.0 g/kg bodyweight for muscle maintenance and repair. This is particularly important during taper when training stimulus drops but the body is still consolidating adaptations from the build phase.
            </motion.p>
            ...
            <motion.p {...fadeUp(0.18)}>
              Stick to simple, low-fibre carbohydrate sources: white rice, white pasta, white bread, pancakes, fruit juice, sports drink, honey. Reduce vegetables, legumes and whole grains temporarily &mdash; they fill you up before you hit your carbohydrate target and can cause bloating.
            </motion.p>
            ...
            <motion.div {...fadeUp(0.22)}>
              ...
              <div className="my-8 rounded-sm overflow-hidden" style={{ border: `1px solid ${CARD_BORDER}` }}>
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {[
                      ["Sprint", "0&ndash;30 g", "Pre-race carb load more important"],
                      ["Olympic", "30&ndash;60 g", "1&ndash;2 gels on bike, nothing on run"],
                      ["70.3", "60&ndash;80 g", "Fuel bike heavily, 30&ndash;60 g/hr on run"],
                      ["Ironman", "80&ndash;90 g", "Gut-trained athletes can reach 120 g/hr"],
                      ...
                      <tr key={i} style={{ borderTop: `1px solid ${CARD_BORDER}` }}>
                        ...
                        <td className="p-3" style={{ color: DIM }} dangerouslySetInnerHTML={{ __html: carbs }} />
            ...
            <motion.p {...fadeUp(0.28)}>
              The biggest nutrition mistake in endurance racing is not what you eat &mdash; it is eating something for the first time on race day. Every gel, every drink, every bar should have been tested under load before you pin on a race number.
            </motion.p>
